...
Let's open the datasets and create pseudo training/testing datasets that we can use to estimate the "out-of-sample" error on models.  The pml-training dataset is partitioned into thirds.   We then compare the predicted values to the pseudo testing dataset to get our categorical Accuracy performance metric.
...
print( "Dataset has been partitioned")
```
...
Setup "classe", "new_window" and "user_name" as Factors.
